...
<div class="content">
      <div class="header">
    <div class="stats">
          <p class="stat"><span class="label label-info">5</span> 信息　</p>
          <p class="stat"><span class="label label-success">27</span> 爬虫　</p>
          <p class="stat"><span class="label label-danger">15</span> 线程</p>
        </div>
    ...
    <div class="panel panel-default"> <a href="#page-stats" class="panel-heading" data-toggle="collapse">系统状态</a>
        ...
        <div class="row">
            ...
            <div class="knob-container">
                  ...
                  <h3 class="text-muted text-center">线程数</h3>
                </div>
          </div>
              <div class="col-md-3 col-sm-6">
            <div class="knob-container">
                  ...
                  <h3 class="text-muted text-center">爬虫数</h3>
                </div>
          </div>
              <div class="col-md-3 col-sm-6">
            <div class="knob-container">
                  ...
                  <h3 class="text-muted text-center">信息数</h3>
                </div>
          </div>
            </div>
      </div>
