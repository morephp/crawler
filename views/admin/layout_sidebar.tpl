<div class="sidebar-nav">
    ...
    <li data-popover="true" data-content="" rel="popover" data-placement="right"><a href="#" data-target=".premium-menu" class="nav-header collapsed" data-toggle="collapse"><i class="fa fa-fw fa-pencil-square-o"></i> 爬虫管理 <span class="label label-info">+{{.CrawlerCount}}</span></a></li>
    <li>
